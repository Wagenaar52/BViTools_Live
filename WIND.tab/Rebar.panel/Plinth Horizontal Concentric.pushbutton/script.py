...
for i in range(1,200):
    ...
    if "PH" in str(xl.Cells(i, 1).Value2).replace(" ","") :
        ...
        x_innerRange = r_groutOuter + top_cover + barDia/2 -70/304.8
        x_range = x_outerRange - x_innerRange
        print("x_outerRange: " + str(x_outerRange*304.8))
        print("x_innerRange: " + str(x_innerRange*304.8))
        print("x_range: " + str(x_range*304.8))
        ...
        for i in range(1, int(no_ConRings)+1):
            ...
            print("x1: " + str(round(x1*304.8)/1000)+'m')
            print("#"*45)
            ...
            if no_bars > 2:
                ...
                for elem in elem:
                    doc.GetElement(elem).LookupParameter("Mark").Set("PLINTH FACE HORIZONTAL")
                ...
                doc.GetElement(rebarCopy[0]).LookupParameter("Mark").Set("PLINTH FACE HORIZONTAL")
