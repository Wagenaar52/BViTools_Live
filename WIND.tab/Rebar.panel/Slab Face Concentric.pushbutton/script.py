...
for i in range(5,200):
    if "BV" in str(xl.Cells(i, 1).Value2):
        barDiaBV = int(str(xl.Cells(i,4).Value2)[1:])/304.8
...
for i in range(1,200):
    ...
    if str(xl.Cells(i, 1).Value2).replace(" ","") == 'SF100':
        ...
        print(str('radius') + "  ---  \t " + bar_mark + "  --- \t \t " + str('##') + "  ---\t \t " + bar_size)
        print("*"*45)  
        #####Rebar Shape ####################################################################
        ...
        print("y_topRange: " + str(y_topRange))
        print("y_Rangebot: " + str(y_Rangebot))
        ...
        for i in range(1, int(no_ConRings)+1):
            ...
            rebarCur.LookupParameter("Mark").Set("SLAB FACE CONCENTRIC")
            ...
            if no_bars > 2:
                ...
                for elem in elem:
                    doc.GetElement(elem).LookupParameter("Mark").Set("SLAB FACE CONCENTRIC")
                ...
                doc.GetElement(rebarCopy[0]).LookupParameter("Mark").Set("SLAB FACE CONCENTRIC")
